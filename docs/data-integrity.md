...
- Replanning an unfinished linked card keeps its task ID and earlier failed dates. Planning a full checklist clears any previous partial `stepSlice`; planning a subset records that subset explicitly.
