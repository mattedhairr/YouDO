...
- Complete and hosted-test the pending item-level conflict/deletion model. Compact markers and conservative merge guards are not proof of multi-device behavior until old-client, restoration, and same-account race cases pass.
